...
namespace CSharpControl2013
{
    public partial class Form1 : Form
    {
        ...
        private void ControlSampleTimer(object sender, EventArgs e)
        {
            ...
            // Controller           
            double Error = rt_SetPoint - yt_PlantOutput - K_Vel*Velocity;
            cumError = cumError + 0.02*errorPrev;
            double ut_Output = Error + Zero*errorPrev - Pole*ut_Out_prev + Ki*cumError;
